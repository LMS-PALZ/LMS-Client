    ...
    return (
        <AuthLayout>
            <div className="flex flex-col items-center">
                ...
                <h1 className="text-2xl font-light-bold text-neutral-900 mb-2">Forgot password?</h1>
                <p className="text-small text-neutral-900 mb-6">Enter the email associated with your account</p>
                {banner && (
                    <div className="mb-4">
