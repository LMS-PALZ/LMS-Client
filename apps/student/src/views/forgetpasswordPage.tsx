    ...
    return (
        <AuthLayout>
            <div className="flex flex-col items-center">
                ...
                <h1 className="text-sm text-[24px] font-bold text-[#1F2937] mb-3 sm:text-[23px]">Forgot password?</h1>
                <p className="text-sm text-neutral-900 mb-6 text-center">Enter the email associated with your account</p>
                {banner && (
                    <div className="mb-4">
